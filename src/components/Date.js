    ...
    <div className="dates_container">
      <div className="start-date_container">
        <label htmlFor="" className="from-date_label">from</label>
          <input type="date" name="startDate"className="from-date_input" onChange={getDate} value={startDate} min={currentDay}/>
      ...
      <div className="end-date_container">
        <label htmlFor="" className="end-date_label">to</label>
          <input type="date" name="endDate"className="end-date_input" onChange={getDate} value={endDate}/>
